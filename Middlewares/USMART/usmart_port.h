...
////////////////默认4改了5//////////////////////////
#define USMART_TIMX                     TIM5
#define USMART_TIMX_IRQn                TIM5_IRQn
#define USMART_TIMX_IRQHandler          TIM5_IRQHandler
#define USMART_TIMX_CLK_ENABLE()        do{ __HAL_RCC_TIM5_CLK_ENABLE(); }while(0)  /* TIMX 时钟使能 */
