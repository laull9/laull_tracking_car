...
//     轮子1:  正负极连F1 F2       PWM连tim3-4  B1        输出
        ...
        /*单轮速度配置*/{/*forward*/DEFAULT_SPEED, /*backward*/DEFAULT_SPEED + 40, /*moveleft*/DEFAULT_SPEED, /*moveright*/DEFAULT_SPEED, /*turnleft*/DEFAULT_SPEED, /*turnright*/DEFAULT_SPEED + 30}};

//     轮子2:  正负极连F3 F4       PWM连tim4-2 D13        输出
        wheel w2 = {WHEEL_PIN_2_1, WHEEL_PIN_2_2, WHEEL_PORT, WHEEL_PORT, &tim4, TIM_CHANNEL_2, 
        /*单轮速度配置*/{/*forward*/DEFAULT_SPEED + 4, /*backward*/DEFAULT_SPEED, /*moveleft*/DEFAULT_SPEED, /*moveright*/DEFAULT_SPEED + 20, /*turnleft*/DEFAULT_SPEED + 30, /*turnright*/DEFAULT_SPEED}};
...
//     轮子4:  正负极连F7 F8       PWM连tim4-4 D15        输出
        ...
        /*单轮速度配置*/{/*forward*/DEFAULT_SPEED + 4, /*backward*/DEFAULT_SPEED, /*moveleft*/DEFAULT_SPEED, /*moveright*/DEFAULT_SPEED + 5, /*turnleft*/DEFAULT_SPEED + 30, /*turnright*/DEFAULT_SPEED}};
...
void run_mainrace(){
    ...
    const u32 TIME_TURN1 = 3.95 * 1000;
    const u32 TIME_TURN2 = 0.73 * 1000;
    const u32 TIME_OBJECT = 1.3 * 1000;
    const u32 TIME_BIDA = 1.55 * 1000;
    const u32 TIME_BIDA_NO_XUN = 0.73 * 1000;
    const u32 TIME_FILLAY = 1.3 * 1000;
    const u32 TIME_MOVE_RIGHT = 0.77 * 1000;
    // 开始阶段，收起机械臂，张开抓取夹
    // as2_up();
